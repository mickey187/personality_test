  ...
  Widget build(BuildContext context) {
    ...
    return RankedResultsView(
      ...
      shareData: ShareCardData(
        profileLabel: testById('leadership')!.name.resolve(lang),
        headline: result.dominant.label(l10n),
        headlineColor: kLeadershipColors[result.dominant]!,
        stats: <ShareStat>[
          for (final LeadershipStyle s in ranked)
            ShareStat(
              label: s.label(l10n),
        ...
        shareText: l10n.leadershipShareText(
          result.dominant.label(l10n),
          Brand.storeUrl,
        ),
      ),
    );
